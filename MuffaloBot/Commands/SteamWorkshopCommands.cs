...
namespace MuffaloBot.Commands
{
    public class SteamWorkshopCommands : BaseCommandModule
    {
        ...
        private const string query = baseUrl + "IPublishedFileService/QueryFiles/v1/?key={0}&format=json&numperpage={1}&appid=294100&match_all_tags=1&excludedtags%5B0%5D=Scenario&search_text={2}&return_short_description=1&return_metadata=1&query_type={3}";
